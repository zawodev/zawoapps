...
def slash_commands_setup(bot, BJG: BlackJackGame):

    @bot.tree.command(name="join table", description="Dołącz do stołu na danym kanale")
    ...
    @bot.tree.command(name="thanks for the tip", description="Podziękuj za napiwek albo odbierz napiwek jako zbankrutowany gracz")
    ...
    @bot.tree.command(name="pay loan", description="Spłać pożyczkę")
